...
import { manuItems } from "../../constance";
...
const Header = () => {
  ...
  return (
    <div
      className={`z-50 py-5  text-white ${
        isScrollY ? "bg-[rgba(0,0,0,0.4)]" : "bg-transparent"
      }  relative`}
    >
          ...
          <div className="relative">
            <div className="flex justify-between items-center overflow-x-hidden">
              <div className="flex items-center gap-8">
                <div className="brands flex items-center gap-2">
                  <svg
                    width="37"
                    height="38"
                    viewBox="0 0 37 38"
                ...
                <div className="md:flex items-center gap-3 hidden">
                  {manuItems.map(({ label, link }) => (
                    <Link className="" key={link} to={link}>
                      {label}
                    </Link>
                  ))}
                </div>
              ...
              <div className="flex gap-5 items-center">
                <button className="btn uppercase hidden sm:block">
                  book a table
                </button>
                {!open && (
                  <RiMenu3Line
            ...
            {open && (
              <div className="absolute top-20 h-[70vh] overflow-y-auto left-0 bg-[rgba(0,0,0,0.5)]  w-full  text-wrap px-3 py-5">
                <div className="flex flex-col gap-7 w-full h-full justify-center items-center">
                  {manuItems.map((item) => (
                    <Link className="" key={item.link} to={item.link}>
                      {item.label}
                    </Link>
                  ))}

                  {open && (
                    <button className="btn uppercase ">book a table</button>
                  )}
                </div>
              </div>
            )}
